            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (results.length > 0) {
                        ...
                        $("#posterImage").attr("src", "${pageContext.request.contextPath}/resources/image/errorPoster.png"); // 검색 결과 없을 경우 이미지 초기화
                    }
                },
                error: function() {
...
<body>
    ...
    <%
        // JSON 파일 읽기
        String apiUrl = "http://www.kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieInfo.json?key=f5eef3421c602c6cb7ea224104795888&movieCd=" + number;
...
<table>
    <tr>
        ...
        <% for (Map<String, String> actor : actors) { %>
            ...
            <td>
                <%= actor.get("peopleNmEn") != null ? actor.get("peopleNmEn") : "" %>
            </td>
            <td>
                <%= actor.get("cast") %>
            </td>
...
<table>
    <tr>
        ...
        <% for (Map<String, String> company : companys) { %>
            ...
            <td>
                <%= company.get("companyNmEn") != null ? company.get("companyNmEn") : "" %>
            </td>
            <td>
                <%= company.get("companyPartNm") %>
            </td>
            </tr><tr>
        <% } %>
    </tr>
