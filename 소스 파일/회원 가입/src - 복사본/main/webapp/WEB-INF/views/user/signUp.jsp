...
<body>
    ...
    <form method="POST" action="/register" onsubmit="return validateForm()">
        <p>아이디 : <input type="text" name="LoginID" id="loginId" placeholder="아이디"/></p>
        ...
        <p>비밀번호 확인 : <input type="password" name="ConfirmPassword" id="confirmPassword" placeholder="비밀번호 확인"/></p>
        ...
        <p>태어난 연도 : <input type="text" name="BirthYear" placeholder="4자리로 입력하세요 EX)1998"/></p>
