 ...
 * Generated at: 2023-06-23 00:35:57 UTC
...
public final class HowMuchDailyMovie_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>개봉작 통계 조회</title>\r\n");
      ...
      out.write("			<label for=\"food-select\">선택:</label> <select id=\"food-select\" onchange=\"updateData()\">\r\n");
      ...
      out.write("			</select> <br>\r\n");
      out.write("\r\n");
      out.write("			<svg id=\"chart\"></svg>\r\n");
      out.write("			<h4>국내 영화 시장 1년 지표</h4>\r\n");
      out.write("			<br>\r\n");
      out.write("			<table id=\"data-table\">\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th>당일 관객</th>\r\n");
      out.write("					<th>영화</th>\r\n");
      ...
      out.write("					<td>");
      out.print(String.format("%,d",amount) + "명");
      out.write("</td>\r\n");
      out.write("					<td>");
      out.print(name);
      out.write("</td>\r\n");
      out.write("					<td>");
      out.print(formattedAmt );
      out.write("</td>\r\n");
      out.write("					<td>");
      out.print(formattedDt);
      out.write("</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				");
...
e.printStackTrace();
      ...
      out.write("			              ];\r\n");
      out.write("\r\n");
      out.write("              // 초기 데이터로 테이블 생성\r\n");
      out.write("              var table = d3.select(\"#data-table\");\r\n");
      out.write("\r\n");
      out.write("              var rows = table.selectAll(\".data-row\")\r\n");
      out.write("                  .data(originalData)\r\n");
      out.write("                  .enter()\r\n");
      out.write("                  .append(\"tr\")\r\n");
      out.write("                  .attr(\"class\", \"data-row\");\r\n");
      out.write("\r\n");
      out.write("              rows.append(\"td\")\r\n");
      out.write("                  .text(function(d) { return d.amount; });\r\n");
      out.write("\r\n");
      out.write("              rows.append(\"td\")\r\n");
      out.write("                  .text(function(d) { return d.name; });\r\n");
      out.write("\r\n");
      out.write("              rows.append(\"td\")\r\n");
      out.write("                  .text(function(d) { return d.itemspec; });\r\n");
      out.write("\r\n");
      out.write("              rows.append(\"td\")\r\n");
      out.write("                  .text(function(d) { return d.year; });\r\n");
      out.write("\r\n");
      out.write("           // 초기 데이터로 차트 생성\r\n");
      out.write("              var chartData = originalData;\r\n");
      out.write("\r\n");
      out.write("              var margin = { top: 20, right: 20, bottom: 30, left: 40 };\r\n");
      out.write("              var width = 1024;\r\n");
      out.write("              var height = 300 - margin.top - margin.bottom;\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("              // 기존의 세로축 요소 제거\r\n");
      out.write("              svg.select(\".y-axis\").remove();\r\n");
      out.write("\r\n");
      out.write("              var x = d3.scaleBand()\r\n");
      out.write("                  .domain(chartData.map(function(d) { return d.year; }))\r\n");
      out.write("                  .range([0, width])\r\n");
      out.write("                  .padding(0.1);\r\n");
      out.write("\r\n");
      out.write("              var y = d3.scaleLinear()\r\n");
      out.write("                  .domain([0, d3.max(chartData, function(d) { return d.amount; })])\r\n");
      out.write("                  .range([height, 0]);\r\n");
      out.write("\r\n");
      out.write("              svg.selectAll(\".bar\")\r\n");
      out.write("                  .data(chartData)\r\n");
      out.write("                  .enter().append(\"rect\")\r\n");
      out.write("                  .attr(\"class\", \"bar\")\r\n");
      out.write("                  .attr(\"x\", function(d) { return x(d.year); })\r\n");
      out.write("                  .attr(\"y\", function(d) { return y(d.amount); })\r\n");
      out.write("                  .attr(\"width\", x.bandwidth())\r\n");
      out.write("                  .attr(\"height\", function(d) { return height - y(d.amount); });\r\n");
      out.write("\r\n");
      out.write("              svg.append(\"g\")\r\n");
      out.write("                  .attr(\"class\", \"x-axis\")\r\n");
      out.write("                  .attr(\"transform\", \"translate(0,\" + height + \")\")\r\n");
      out.write("                  .call(d3.axisBottom(x));\r\n");
      out.write("\r\n");
      out.write("              svg.append(\"g\")\r\n");
      out.write("                  .attr(\"class\", \"y-axis\")\r\n");
      out.write("                  .call(d3.axisLeft(y));\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("              // 데이터 갱신 함수\r\n");
      out.write("              function updateData() {\r\n");
      out.write("                  var selectedFood = document.getElementById(\"food-select\").value;\r\n");
      out.write("\r\n");
      out.write("                  // 선택된 음식에 따라 테이블과 차트 데이터 필터링\r\n");
      out.write("                  if (selectedFood) {\r\n");
      out.write("                      var filteredData = originalData.filter(function(d) {\r\n");
      out.write("                          return d.name === selectedFood;\r\n");
      out.write("                      });\r\n");
      out.write("\r\n");
      out.write("                      // 테이블 업데이트\r\n");
      out.write("                      var tableRows = table.selectAll(\".data-row\")\r\n");
      out.write("                          .data(filteredData, function(d) { return d.year; });\r\n");
      out.write("\r\n");
      out.write("                      tableRows.exit().remove();\r\n");
      out.write("\r\n");
      out.write("                      var newRows = tableRows.enter()\r\n");
      out.write("                          .append(\"tr\")\r\n");
      out.write("                          .attr(\"class\", \"data-row\");\r\n");
      out.write("\r\n");
      out.write("                      newRows.append(\"td\");\r\n");
      out.write("                      newRows.append(\"td\");\r\n");
      out.write("                      newRows.append(\"td\");\r\n");
      out.write("                      newRows.append(\"td\");\r\n");
      out.write("\r\n");
      out.write("                      tableRows = newRows.merge(tableRows);\r\n");
      out.write("\r\n");
      out.write("                      tableRows.select(\"td:nth-child(1)\")\r\n");
      out.write("                          .text(function(d) { return d.amount; });\r\n");
      out.write("\r\n");
      out.write("                      tableRows.select(\"td:nth-child(2)\")\r\n");
      out.write("                          .text(function(d) { return d.name; });\r\n");
      out.write("\r\n");
      out.write("                      tableRows.select(\"td:nth-child(3)\")\r\n");
      out.write("                          .text(function(d) { return d.itemspec; });\r\n");
      out.write("\r\n");
      out.write("                      tableRows.select(\"td:nth-child(4)\")\r\n");
      out.write("                          .text(function(d) { return d.year; });\r\n");
      out.write("\r\n");
      out.write("                      // 차트 업데이트\r\n");
      out.write("                      svg.select(\".y-axis\").remove(); // 기존의 y축 요소 제거\r\n");
      out.write("                      svg.select(\".x-axis\").remove(); // 기존의 x축 요소 제거\r\n");
      out.write("				        x.domain(filteredData.map(function(d) { return d.year; })); // x 축 도메인 업데이트\r\n");
      out.write("				        y.domain([0, d3.max(filteredData, function(d) { return d.amount; })]); // y 축 도메인 업데이트\r\n");
      out.write("\r\n");
      out.write("                      var chartBars = svg.selectAll(\".bar\")\r\n");
      out.write("                          .data(filteredData, function(d) { return d.year; });\r\n");
      out.write("\r\n");
      out.write("                      chartBars.exit().remove();\r\n");
      out.write("\r\n");
      out.write("                      chartBars.enter()\r\n");
      ...
      out.write("                          .call(d3.axisLeft(y));\r\n");
      out.write("                  } else {\r\n");
      out.write("                      // 선택된 음식이 없을 때 모든 데이터 표시\r\n");
      out.write("                      var tableRows = table.selectAll(\".data-row\")\r\n");
      out.write("                          .data(originalData, function(d) { return d.year; });\r\n");
      out.write("\r\n");
      out.write("                      tableRows.exit().remove();\r\n");
      out.write("\r\n");
      out.write("                      var newRows = tableRows.enter()\r\n");
      ...
      out.write("\r\n");
      out.write("                      chartBars.exit().remove();\r\n");
      out.write("                      x.domain(originalData.map(function(d) { return d.year; })); // x 축 도메인 업데이트\r\n");
      out.write("                      y.domain([0, d3.max(originalData, function(d) { return d.amount; })]); // y 축 도메인 업데이트\r\n");
      out.write("\r\n");
      out.write("                      chartBars.enter()\r\n");
      out.write("                          .append(\"rect\")\r\n");
      out.write("                          .attr(\"class\", \"bar\")\r\n");
