 ...
 * Generated at: 2023-06-23 01:41:28 UTC
...
public final class mainBoard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/movie/../logoutBar.jsp", Long.valueOf(1687484246825L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("	function searchMovie(movieTitle, rank) {\r\n");
      ...
      out.write("						searchMovieByEnglishTitle(movieNmEn, rank, movieTitle);\r\n");
      out.write("						//console.log(rank + \" : \" + movieNmEn + \"(eng)\"); // 검색 방식 로그 출력\r\n");
      out.write("					} else {\r\n");
      out.write("						searchMovieByKoreanTitle(movieTitle, rank);\r\n");
      ...
      out.write("	}\r\n");
      out.write("\r\n");
      out.write("	function searchMovieByEnglishTitle(movieTitle, rank, movieNm) {\r\n");
      out.write("		var apiKey = \"e2a56aa6721d47327a92acc02bfbddf3\"; // 본인의 API 키로 대체해야 합니다.\r\n");
      ...
      out.write("						$(\"#posterImage\" + rank).attr(\"src\", posterUrl); // 포스터 이미지 업데이트\r\n");
      out.write("					} else {\r\n");
      out.write("						searchMovieByKoreanTitle(movieNm, rank);\r\n");
      out.write("					}\r\n");
      out.write("				} else {\r\n");
      out.write("					searchMovieByKoreanTitle(movieNm, rank);\r\n");
      out.write("				}\r\n");
      ...
      out.write("	function searchMovieByKoreanTitle(movieTitle, rank) {\r\n");
      out.write("		var apiKey = \"e2a56aa6721d47327a92acc02bfbddf3\"; // 본인의 API 키로 대체해야 합니다.\r\n");
      out.write("		var encodedTitle = encodeURIComponent(movieTitle);\r\n");
      out.write("		var apiUrl = \"https://api.themoviedb.org/3/search/movie?api_key=\"\r\n");
      out.write("				+ apiKey + \"&query=\" + encodedTitle;\r\n");
      ...
      out.write("					},\r\n");
      out.write("					error : function() {\r\n");
      out.write("						$(\"#posterImage\" + rank).attr(\"src\", \"\"); // 에러 발생 시 이미지 초기화\r\n");
      out.write("					}\r\n");
      out.write("				});\r\n");
      out.write("	}\r\n");
      out.write("</script>\r\n");
      ...
      out.write("        \r\n");
      out.write("    <!-- 기타 메뉴 항목들 -->\r\n");
      out.write("    <span id=\"logout\" style=\"display: ");
      out.print( session.getAttribute("loginid") != null ? "inline" : "none" );
      out.write("\"><a href=\"/logout\">로그아웃</a></span> <!-- 로그아웃 링크 -->\r\n");
      out.write("    <span id=\"update-profile\" style=\"display: ");
      out.print( session.getAttribute("loginid") != null ? "inline" : "none" );
      out.write("\"><a href=\"/update\">내 정보 수정</a></span> <!-- 내 정보 수정 링크 -->\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!-- 자바스크립트 -->\r\n");
      out.write("<script>\r\n");
      out.write("    var usernameElement = document.getElementById(\"username\");\r\n");
      out.write("    var loginId = \"");
      out.print( session.getAttribute("loginid") );
      out.write("\"; // 세션에서 로그인 ID를 가져옴\r\n");
      out.write("\r\n");
      out.write("    if (loginId) {\r\n");
      out.write("        // 로그인 중인 경우 사용자명 표시\r\n");
      out.write("        usernameElement.textContent = \"사용자명: \" + loginId;\r\n");
      out.write("        \r\n");
      ...
      out.write("\r\n");
      out.write("            // 로그아웃까지 남은 시간 표시\r\n");
      out.write("            document.getElementById(\"logout-timer\").innerHTML = minutes + \"분 \" + seconds + \"초\";\r\n");
      out.write("\r\n");
      ...
      out.write("        }, 1000);\r\n");
      out.write("    } else {\r\n");
      out.write("        // 로그인 중이 아닌 경우 시간 표시 영역을 숨김 처리\r\n");
      out.write("        document.getElementById(\"logout-timer\").style.display = \"none\";\r\n");
      out.write("    }\r\n");
      out.write("</script>\r\n");
      out.write('\r');
      out.write('\n');
